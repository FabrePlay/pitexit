...
export default function UserProfile({ user, onClose, onUpdateUser }: UserProfileProps) {
                        ...
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-400">Creado hace {Math.floor(Math.random() * 30) + 1} días</p>
                            </div>
                          </div>
                          <button
